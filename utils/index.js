...
const { cleanseData, checkConn, generateSqlQueryFile, parseSqlUpdateStmt } = require('./dbHelper');
...
const { ALPHA_WHITESPACE_REGEX, DATETIME_REGEX, HASHTAG_REGEX, PASSWORD_REGEX } = require('./regex');
