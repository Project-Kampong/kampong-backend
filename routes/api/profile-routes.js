...
const { advancedResults, checkInputError, decodeHashedReqKey, protect, authorise, mapSingleFileLocation } = require('../../middleware');
const { DATETIME_REGEX, INVALID_TIMESTAMP_MSG, INVALID_FIELD_MSG, NO_FIELD_UPDATED_MSG, uploadFile } = require('../../utils');

// import controllers here
const { getProfiles, getProfile, updateProfile, verifyProfile, uploadPic } = require('../../controllers/profiles');
