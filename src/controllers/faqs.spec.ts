...
import { checkListingOwner, ErrorResponse, ModelValidator } from '../utils';
...
describe('FaqsController', () => {
    beforeEach(() => {
        faqsController = new FaqsController(mockFaqsRepository, mockListingsRepository, mockModelValidator);
    });
