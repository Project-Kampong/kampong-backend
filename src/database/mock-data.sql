...
/* Listings population */
INSERT INTO "public"."listings" ("listing_id", "created_by", "title", "category", "about", "tagline", "mission", "listing_url", "pics", "is_published", "is_verified", "start_date", "end_date", "created_on", "deleted_on", "listing_status", "listing_email") VALUES
...
insert into ListingUpdates (listing_id, description, pics, created_on, updated_on) values ('c975a572-452d-4824-8ed5-500b50488436', 'Persistent regional open system', ARRAY['https://robohash.org/sedaspernaturomnis.bmp?size=500x500&set=set1', 'https://robohash.org/autdeseruntdolorem.bmp?size=500x500&set=set1', 'https://robohash.org/autnumquamitaque.png?size=500x500&set=set1', 'https://robohash.org/molestiaefacereautem.bmp?size=500x500&set=set1'], '2019-11-17 10:37:58', '2020-04-17 07:43:37');
insert into ListingUpdates (listing_id, description, pics, created_on, updated_on) values ('c975a572-452d-4824-8ed5-500b50488436', 'Intuitive secondary complexity', ARRAY['https://robohash.org/nihildolorqui.png?size=500x500&set=set1', 'https://robohash.org/quieiusquo.jpg?size=500x500&set=set1', 'https://robohash.org/quidemquibusdamquia.bmp?size=500x500&set=set1'], '2019-03-26 14:42:40', '2019-11-08 21:10:46');
insert into ListingUpdates (listing_id, description, pics, created_on, updated_on) values ('c975a572-452d-4824-8ed5-500b50488436', 'Phased reciprocal parallelism', ARRAY['https://robohash.org/providentdolorrecusandae.png?size=500x500&set=set1', 'https://robohash.org/consequaturabalias.png?size=500x500&set=set1', 'https://robohash.org/enimnobisconsequatur.jpg?size=500x500&set=set1', 'https://robohash.org/sedfacerepraesentium.bmp?size=500x500&set=set1', 'https://robohash.org/perferendisaniminesciunt.jpg?size=500x500&set=set1'], '2019-04-07 14:09:54', '2020-03-05 03:18:07');
insert into ListingUpdates (listing_id, description, pics, created_on, updated_on) values ('d95a6c2e-3c33-447c-be0c-be399247dd3f', 'Enterprise-wide leading edge productivity', ARRAY['https://robohash.org/aliasetest.jpg?size=500x500&set=set1', 'https://robohash.org/necessitatibusimpeditmodi.jpg?size=500x500&set=set1', 'https://robohash.org/assumendasiteligendi.bmp?size=500x500&set=set1', 'https://robohash.org/quiasuntassumenda.bmp?size=500x500&set=set1'], '2020-06-03 08:49:01', '2019-08-20 09:01:49');
insert into ListingUpdates (listing_id, description, pics, created_on, updated_on) values ('cf4adc93-3b96-4bbc-8cb0-41e196b145ac', 'Business-focused multi-state productivity', ARRAY['https://robohash.org/doloresisteblanditiis.jpg?size=500x500&set=set1', 'https://robohash.org/suntveroet.jpg?size=500x500&set=set1', 'https://robohash.org/quosquorerum.bmp?size=500x500&set=set1', 'https://robohash.org/sitmollitiaipsa.jpg?size=500x500&set=set1', 'https://robohash.org/esseexincidunt.bmp?size=500x500&set=set1'], '2020-04-19 07:13:44', '2020-07-17 21:39:35');
