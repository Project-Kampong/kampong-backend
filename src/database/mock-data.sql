...
('43824166-bee2-426e-8a08-ca2c4e4120ae', 'f96b2138-1754-4c17-a405-940e20adc601', 'Rebuilding Homes', 'Community', 'Customer-focused dynamic installation', 'Building Better Lives', 'Sharing compassion', 'http://ifeng.com/nisl.jsp', 'https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260', 'https://robohash.org/ipsaiuresed.bmp?size=500x500&set=set1', 'https://robohash.org/animiautvoluptas.jpg?size=500x500&set=set1', 'https://robohash.org/fugaidconsequatur.png?size=500x500&set=set1', NULL, 'f', 'f', '2020-12-01 19:09:20', NULL, '2020-08-20 17:36:45.815638', NULL, 'ongoing', 'rebuildhome@gmail.com'),
('c975a572-452d-4824-8ed5-500b50488436', 'b7662cd1-a2c9-4054-95e7-078e35ea6fa1', 'CommStart 2020', 'Enterprise', 'Team-oriented context-sensitive forecast', 'Innovating Ideas, Creating Opportunities', 'Cultivating entrepreneurship and community impact', 'https://ehow.com/in/imperdiet/et/commodo/vulputate/justo.xml', 'https://images.pexels.com/photos/3637796/pexels-photo-3637796.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260', NULL, NULL, NULL, NULL, 'f', 'f', '2020-07-30 13:54:45', NULL, '2020-08-20 17:36:45.815638', NULL, 'ongoing', 'commstart2020@gmail.com'),
...
('d95a6c2e-3c33-447c-be0c-be399247dd3f', 'd69a127d-815b-4834-b2b6-54ab398fccad', 'Supporting COVID-19 Efforts', 'COVID-19', 'Triple-buffered client-server installation', 'Emerge stronger together', 'streamline web-enabled ROI', 'https://mtv.com/blandit/mi/in.png', 'https://images.pexels.com/photos/127873/pexels-photo-127873.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260', NULL, 'https://robohash.org/auteligendimagnam.bmp?size=500x500&set=set1', NULL, NULL, 'f', 'f', '2020-01-01 20:54:13', NULL, '2020-08-20 17:36:45.815638', NULL, 'ongoing', 'fightcovid@gmail.com'),
('e411bd80-d5cf-49ac-b847-18c9fc13377a', '2e9c26a0-7c1c-49d1-8c78-3a0545ca22eb', 'Project Donation Drive', 'Elderly Care', 'Adaptive disintermediate Graphical User Interface', 'Bridging communities', 'e-enable dot-com metrics', 'http://i2i.jp/rhoncus/dui/vel.jpg', 'https://images.pexels.com/photos/339620/pexels-photo-339620.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260', NULL, 'https://robohash.org/atquemolestiasvelit.jpg?size=500x500&set=set1', 'https://robohash.org/nonquodquam.png?size=500x500&set=set1', 'https://robohash.org/voluptaslaborumsimilique.png?size=500x500&set=set1', 'f', 'f', '2020-03-19 11:04:15', NULL, '2020-08-20 17:36:45.815638', NULL, 'completed', 'donationdrive2020@gmail.com');
...
/* Organisations */
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Shuffledrive', 'Consultancy', 'Distributed 4th generation forecast', 'microsoft.com', '8765378253', 'mallgood0@slideshare.net', null, 'Multi-layered regional framework');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Thoughtmix', 'Sponsor', 'Decentralized empowering artificial intelligence', null, '7578453922', 'lspeers1@reddit.com', ARRAY['Tampines','Simei'], 'Open-architected empowering toolset');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Gabvine', 'Consultancy', 'Synchronised next generation concept', 'apache.org', '7364748602', 'bbenton2@miibeian.gov.cn', ARRAY['Tampines','Simei'], 'Balanced tangible leverage');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Skalith', null, 'Compatible content-based secured line', 'boston.com', null, 'arender3@discuz.net', ARRAY['Tampines','Simei'], null);
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Avaveo', 'Government', 'Customer-focused leading edge customer loyalty', null, '1995709220', 'tmarskell4@smh.com.au', ARRAY['Tampines','Simei'], 'Assimilated multi-state ability');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Innotype', 'Government', 'Networked asynchronous neural-net', 'barnesandnoble.com', '9674796018', 'ccusick5@uiuc.edu', ARRAY['Tampines','Simei'], 'Seamless multi-tasking archive');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Browsezoom', 'Sponsor', 'Decentralized systemic attitude', null, '7856198648', 'sstoneley6@google.com.br', ARRAY['Tampines','Simei'], 'Optional analyzing customer loyalty');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Wikido', null, 'Integrated high-level circuit', null, null, 'rvowels7@shinystat.com', ARRAY['Tampines','Simei'], null);
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Teklist', 'Charity', 'Programmable real-time customer loyalty', 'purevolume.com', '5968240238', 'ksaltmarsh8@loc.gov', ARRAY['Tampines','Simei'], 'Team-oriented human-resource artificial intelligence');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Twinder', 'MNC', 'Operative attitude-oriented array', null, '6589137746', 'teyam9@yale.edu', ARRAY['Tampines','Simei'], 'Virtual directional groupware');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Flashdog', 'MNC', 'Quality-focused impactful pricing structure', null, '3878301489', 'cwhitlama@macromedia.com', ARRAY['Tampines','Simei'], 'Team-oriented modular core');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Chatterpoint', null, 'Re-engineered system-worthy capability', 'nih.gov', null, 'cweekeb@webeden.co.uk', ARRAY['Tampines','Simei'], null);
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Fatz', 'MNC', 'Decentralized modular hierarchy', 'intel.com', '3032094893', 'tsessionsc@eventbrite.com', ARRAY['Tampines','Simei'], 'User-centric discrete complexity');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Topicshots', 'Government', 'Face to face zero tolerance knowledge user', 'toplist.cz', '7078286517', 'nharmantd@gnu.org', ARRAY['Tampines','Simei'], 'Total maximized encoding');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Skipfire', 'Consultancy', 'User-centric zero tolerance extranet', null, '1777985640', 'olenniee@addthis.com', ARRAY['Tampines','Simei'], 'Team-oriented solution-oriented internet solution');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Kazu', 'Government', 'Front-line uniform collaboration', 'printfriendly.com', '9785011485', 'tcarneckf@unc.edu', ARRAY['Tampines','Simei'], 'Realigned well-modulated encryption');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Buzzbean', null, 'Future-proofed demand-driven contingency', 'craigslist.org', null, 'rpaxfordeg@amazon.de', ARRAY['Tampines','Simei'], null);
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Camimbo', 'MNC', 'Cross-group zero defect paradigm', 'ask.com', '7043362671', 'ocayfordh@theglobeandmail.com', ARRAY['Tampines','Simei'], 'Open-source user-facing approach');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Dynazzy', 'MNC', 'Quality-focused national customer loyalty', '123-reg.co.uk', '7631507862', 'gjessetti@nih.gov', ARRAY['Tampines','Simei'], 'Centralized actuating projection');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Dynabox', 'Charity', 'Multi-tiered zero administration website', 'army.mil', '8528916285', 'emingardij@prnewswire.com', null, 'Phased next generation concept');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Roombo', 'MNC', 'Decentralized executive paradigm', 'rambler.ru', '5534658919', 'kmeesonk@taobao.com', null, 'Persistent stable function');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Brainbox', 'Sponsor', 'Reduced didactic time-frame', 'rakuten.co.jp', '8256694312', 'mridgedelll@sourceforge.net', null, 'Business-focused asynchronous knowledge user');
insert into organisations (name, organisation_type, about, website_url, phone, email, locations, story) values ('Jaxbean', null, 'Diverse reciprocal installation', 'hatena.ne.jp', null, 'gheggiem@columbia.edu', null, null);

insert into programmes (organisation_id, title, about, media_url) values (12, 'Innovative object-oriented utilisation', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', null);
insert into programmes (organisation_id, title, about, media_url) values (6, 'Proactive actuating Graphic Interface', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.
...
insert into programmes (organisation_id, title, about, media_url) values (17, 'Multi-lateral human-resource software', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.
...
insert into programmes (organisation_id, title, about, media_url) values (7, 'Universal heuristic implementation', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (10, 'Open-source composite neural-net', 'Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.
...
insert into programmes (organisation_id, title, about, media_url) values (3, 'Synchronised local superstructure', 'Sed ante. Vivamus tortor. Duis mattis egestas metus.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (4, 'Virtual bi-directional alliance', 'Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (10, 'Multi-tiered global Graphical User Interface', 'Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.
...
insert into programmes (organisation_id, title, about, media_url) values (15, 'Fully-configurable context-sensitive productivity', 'Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', null);
insert into programmes (organisation_id, title, about, media_url) values (23, 'Operative asynchronous ability', 'Quisque porta volutpat erat. Quisque erat eros, viverra eget, congue eget, semper rutrum, nulla. Nunc purus.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (10, 'Networked asymmetric analyzer', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', null);
insert into programmes (organisation_id, title, about, media_url) values (22, 'Monitored explicit local area network', 'Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.

Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', null);
insert into programmes (organisation_id, title, about, media_url) values (3, 'Virtual homogeneous Graphic Interface', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.
...
insert into programmes (organisation_id, title, about, media_url) values (19, 'Devolved 4th generation conglomeration', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (21, 'Quality-focused background definition', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.
...
insert into programmes (organisation_id, title, about, media_url) values (5, 'Inverse full-range extranet', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.
...
insert into programmes (organisation_id, title, about, media_url) values (9, 'Virtual context-sensitive core', 'Proin eu mi. Nulla ac enim. In tempor, turpis nec euismod scelerisque, quam turpis adipiscing lorem, vitae mattis nibh ligula nec sem.

Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', null);
insert into programmes (organisation_id, title, about, media_url) values (5, 'Public-key even-keeled migration', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.

Integer ac leo. Pellentesque ultrices mattis odio. Donec vitae nisi.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (7, 'Distributed client-server installation', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.
...
insert into programmes (organisation_id, title, about, media_url) values (22, 'Function-based impactful protocol', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Proin risus. Praesent lectus.

Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.

Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (16, 'User-friendly uniform knowledge base', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (13, 'Stand-alone grid-enabled encryption', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (7, 'Monitored mobile utilisation', 'Vestibulum quam sapien, varius ut, blandit non, interdum in, ante. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Duis faucibus accumsan odio. Curabitur convallis.

Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.', ARRAY['https://youtube.com','https://instagram.com']);
insert into programmes (organisation_id, title, about, media_url) values (18, 'Versatile explicit extranet', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.

Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', null);
insert into programmes (organisation_id, title, about, media_url) values (14, 'Open-architected 24 hour function', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.
...
insert into programmes (organisation_id, title, about, media_url) values (20, 'Persevering tangible framework', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.
