...
/* Listings population */
INSERT INTO "public"."listing" ("listing_id", "created_by", "title", "category", "about", "tagline", "mission", "listing_url", "pics", "is_published", "is_verified", "start_date", "end_date", "created_on", "deleted_on", "listing_status", "listing_email") VALUES
('1276b4eb-df3a-4de3-bcae-a450ed96eeac', 'b7662cd1-a2c9-4054-95e7-078e35ea6fa1', 'Project Kampong', 'Technology', NULL, 'With Kampong you can', 'To build a platform that connects people with ideas and skills to build and track social good project initiatives', 'www.test.com', ARRAY['https://kampong-dev.s3.ap-southeast-1.amazonaws.com/kampong%20logo-1597985636566.jpeg', 'https://kampong-dev.s3.ap-southeast-1.amazonaws.com/group-large-1597985817857.png'], 'f', 'f', '2020-08-21 04:50:15.047753', NULL, '2020-08-21 04:50:15.047753', NULL, 'ongoing', 'joinourkampong@gmail.com'),
('43824166-bee2-426e-8a08-ca2c4e4120ae', 'f96b2138-1754-4c17-a405-940e20adc601', 'Rebuilding Homes', 'Housing', 'Customer-focused dynamic installation', 'Building Better Lives', 'Sharing compassion', 'http://ifeng.com/nisl.jsp', ARRAY['https://images.pexels.com/photos/2219024/pexels-photo-2219024.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260', 'https://robohash.org/ipsaiuresed.bmp?size=500x500&set=set1', 'https://robohash.org/animiautvoluptas.jpg?size=500x500&set=set1', 'https://robohash.org/fugaidconsequatur.png?size=500x500&set=set1'], 'f', 'f', '2020-12-01 19:09:20', NULL, '2020-08-20 17:36:45.815638', NULL, 'ongoing', 'rebuildhome@gmail.com'),
('c975a572-452d-4824-8ed5-500b50488436', 'b7662cd1-a2c9-4054-95e7-078e35ea6fa1', 'CommStart 2020', 'Manpower', 'Team-oriented context-sensitive forecast', 'Innovating Ideas, Creating Opportunities', 'Cultivating entrepreneurship and community impact', 'https://ehow.com/in/imperdiet/et/commodo/vulputate/justo.xml', ARRAY['https://images.pexels.com/photos/3637796/pexels-photo-3637796.jpeg?auto=compress&cs=tinysrgb&h=750&w=1260'], 'f', 'f', '2020-07-30 13:54:45', NULL, '2020-08-20 17:36:45.815638', NULL, 'ongoing', 'commstart2020@gmail.com'),
...
('d95a6c2e-3c33-447c-be0c-be399247dd3f', 'd69a127d-815b-4834-b2b6-54ab398fccad', 'Supporting COVID-19 Efforts', 'Health', 'Triple-buffered client-server installation', 'Emerge stronger together', 'streamline web-enabled ROI', 'https://mtv.com/blandit/mi/in.png', ARRAY['https://images.pexels.com/photos/127873/pexels-photo-127873.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260', 'https://robohash.org/auteligendimagnam.bmp?size=500x500&set=set1'], 'f', 'f', '2020-01-01 20:54:13', NULL, '2020-08-20 17:36:45.815638', NULL, 'ongoing', 'fightcovid@gmail.com'),
...
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('43824166-bee2-426e-8a08-ca2c4e4120ae', 'Horizontal dynamic encoding', ARRAY['https://robohash.org/utetut.bmp?size=500x500&set=set1', 'https://robohash.org/quiserrorlabore.jpg?size=500x500&set=set1', 'https://robohash.org/aspernaturcupiditateerror.png?size=500x500&set=set1', 'https://robohash.org/dolorevenietmaiores.jpg?size=500x500&set=set1', 'https://robohash.org/utconsequaturatque.bmp?size=500x500&set=set1'], '2020-05-05 02:20:02', '2020-04-28 01:06:06');
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('43824166-bee2-426e-8a08-ca2c4e4120ae', 'Inverse eco-centric conglomeration', ARRAY['https://robohash.org/sititaqueiure.jpg?size=500x500&set=set1', 'https://robohash.org/facilisimpeditsoluta.bmp?size=500x500&set=set1', 'https://robohash.org/atquererumvoluptatem.jpg?size=500x500&set=set1', 'https://robohash.org/quietreprehenderit.bmp?size=500x500&set=set1', 'https://robohash.org/suscipittemporeet.png?size=500x500&set=set1'], '2020-07-08 12:26:55', '2020-08-10 10:06:35');
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('c975a572-452d-4824-8ed5-500b50488436', 'Persistent regional open system', ARRAY['https://robohash.org/sedaspernaturomnis.bmp?size=500x500&set=set1', 'https://robohash.org/autdeseruntdolorem.bmp?size=500x500&set=set1', 'https://robohash.org/autnumquamitaque.png?size=500x500&set=set1', 'https://robohash.org/molestiaefacereautem.bmp?size=500x500&set=set1'], '2019-11-17 10:37:58', '2020-04-17 07:43:37');
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('c975a572-452d-4824-8ed5-500b50488436', 'Intuitive secondary complexity', ARRAY['https://robohash.org/nihildolorqui.png?size=500x500&set=set1', 'https://robohash.org/quieiusquo.jpg?size=500x500&set=set1', 'https://robohash.org/quidemquibusdamquia.bmp?size=500x500&set=set1'], '2019-03-26 14:42:40', '2019-11-08 21:10:46');
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('c975a572-452d-4824-8ed5-500b50488436', 'Phased reciprocal parallelism', ARRAY['https://robohash.org/providentdolorrecusandae.png?size=500x500&set=set1', 'https://robohash.org/consequaturabalias.png?size=500x500&set=set1', 'https://robohash.org/enimnobisconsequatur.jpg?size=500x500&set=set1', 'https://robohash.org/sedfacerepraesentium.bmp?size=500x500&set=set1', 'https://robohash.org/perferendisaniminesciunt.jpg?size=500x500&set=set1'], '2019-04-07 14:09:54', '2020-03-05 03:18:07');
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('d95a6c2e-3c33-447c-be0c-be399247dd3f', 'Enterprise-wide leading edge productivity', ARRAY['https://robohash.org/aliasetest.jpg?size=500x500&set=set1', 'https://robohash.org/necessitatibusimpeditmodi.jpg?size=500x500&set=set1', 'https://robohash.org/assumendasiteligendi.bmp?size=500x500&set=set1', 'https://robohash.org/quiasuntassumenda.bmp?size=500x500&set=set1'], '2020-06-03 08:49:01', '2019-08-20 09:01:49');
insert into listingupdate (listing_id, description, pics, created_on, updated_on) values ('cf4adc93-3b96-4bbc-8cb0-41e196b145ac', 'Business-focused multi-state productivity', ARRAY['https://robohash.org/doloresisteblanditiis.jpg?size=500x500&set=set1', 'https://robohash.org/suntveroet.jpg?size=500x500&set=set1', 'https://robohash.org/quosquorerum.bmp?size=500x500&set=set1', 'https://robohash.org/sitmollitiaipsa.jpg?size=500x500&set=set1', 'https://robohash.org/esseexincidunt.bmp?size=500x500&set=set1'], '2020-04-19 07:13:44', '2020-07-17 21:39:35');
